...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-billing-domains-api?sort=semver)](https://github.com/liberusoftware/module-billing-domains-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-billing-domains-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-billing-domains-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-billing-domains-api
```
...
<a href="https://github.com/liberusoftware/module-billing-domains-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-billing-domains-api" alt="Contributors to liberusoftware/module-billing-domains-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-billing-domains-api/graphs/contributors).
